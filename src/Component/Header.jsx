...
const ResponsiveMenu = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      title: 'WHAT WE DO',
      children: [
        { key: 'ecommerceMarketing', title: 'E-COMMERCE MARKETING', link: '/ecommerce-marketing' },
        { key: 'marketplaceManagement', title: 'FULL-SERVICE MARKETPLACE MANAGEMENT', link: '/marketplace-management' }
      ]
    },
    {
      key: 'services',
  ...
  return (
    <header className="fixed top-0 left-0 w-full shadow-lg z-50 bg-transparent backdrop-blur-lg overflow-hidden overflow-x-hidden">
      <div className="flex flex-col md:flex-row items-center justify-between max-w-screen-xl mx-auto px-4 py-4">
        {/* Contact Info */}
      ...
      <div className="flex justify-between items-center -mt-3 px-8">
        ...
        <div className="hidden md:block">
          <Menu mode="horizontal" className="text-sm bg-transparent justify-center mt-12 font-bold" triggerSubMenuAction="hover">
            {menuItems.map((item) =>
              item.children ? (
