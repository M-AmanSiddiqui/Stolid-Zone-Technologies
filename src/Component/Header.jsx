...
//         // State to manage whether the input field is visible or not
//         const [isOpen, setIsOpen] = useState(false);
...
//         className="bg-blue-600 text-white p-3 rounded-full flex items-center justify-center transition-all duration-300 ease-in-out"
//       >
//         <BsSearch size={20} />
//       </button>
...
//         type="text"
//         placeholder="Search..."
//         className={`absolute top-0 left-0 mt-12 ml-2 px-4 py-2 rounded-full border-2 border-blue-600 focus:outline-none transition-all duration-300 ease-in-out ${
