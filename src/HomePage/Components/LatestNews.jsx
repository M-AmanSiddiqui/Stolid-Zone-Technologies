...
//                 <span className="text-gray-500 flex gap-2"><FaBook className="mt-1 text-blue-500"/> Business Solution</span>
...
//                 <FaCircleUser size={38}  className="text-gray-300"/>
//                   <span className="-mt-5">Superadmin</span>
//                 </div>
//                 <div className="flex items-center text-xs ml-12 -mt-5 text-gray-500 ">
...
//             <div className="p-6">
//               <div className="text-sm text-gray-500 font-semibold flex items-center gap-2">
//                 <span className="text-gray-500 flex gap-2"><FaBook className="mt-1 text-blue-500"/> Finance Solution</span>
//               </div><hr  className="mt-6"/>
//               <h3 className="text-xl font-semibold mt-6">
...
//             <div className="p-6">
//               <div className="text-sm text-gray-500 font-semibold flex items-center gap-2">
//                 <span className="text-gray-500 flex gap-2"><FaBook className="mt-1 text-blue-500"/> Investment Policy</span>
//               </div><hr  className="mt-6"/>
//               <h3 className="text-xl font-semibold mt-6">
//                 The Ultimate Guide to Financial Advisory and Planning
//               </h3><hr  className="mt-6"/>
//               <div className="items-center text-lg mt-6 gap-4">
//                 <div className="flex items-center gap-2 font-semibold">
//                 <FaCircleUser size={38}  className="text-gray-300"/>
//                   <span className="-mt-5">Superadmin</span>
